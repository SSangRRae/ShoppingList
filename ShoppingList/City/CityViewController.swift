...
class CityViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if segmentIndex == 0 {
            cell.designCell(city[indexPath.item])
        } else if segmentIndex == 1 {
            cell.designCell(domestic[indexPath.item])
        } else {
            cell.designCell(oversea[indexPath.item])
        }
